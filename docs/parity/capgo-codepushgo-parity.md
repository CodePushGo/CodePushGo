...
CodePushGo test count: 369

| Suite | Source tests/flows | CodePushGo matching files | Status |
| --- | ---: | ---: | --- |
| Capgo backend tests | 224 | 247 | verified |
...
| Capgo API keys console route present | pass | API keys are managed through a real console page with Worker CRUD, regeneration, one-time secret display, and Capgo org settings redirect parity |
