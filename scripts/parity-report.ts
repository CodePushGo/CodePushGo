...
const semanticChecks: SemanticCheck[] = [
  ...
  semanticCheck('Capgo channel detail route present', dashboardRouter.includes('ConsoleChannelDetailPage') && dashboardRouter.includes("{ path: 'channel/:channel', component: ConsoleChannelDetailPage }") && !dashboardRouter.includes("{ path: 'channel/:channel', component: ConsoleChannelsPage }") && dashboardChannelTable.includes('RouterLink') && dashboardChannelTable.includes('function channelHref') && dashboardChannelTable.includes('/channel/') && dashboardConsoleChannelsPage.includes(':app-id="selectedAppId"') && dashboardConsoleChannelDetailPage.includes('useRoute') && dashboardConsoleChannelDetailPage.includes('decodedChannelName') && dashboardConsoleChannelDetailPage.includes('channelReleases') && dashboardConsoleChannelDetailPage.includes('channelDevices'), 'channel rows navigate to a real app-scoped detail route instead of routing detail paths back to the list page'),
