import type { LtvSourceRow } from '../../../scripts/backfill_ltv_metrics'
import { describe, expect, it } from 'vitest'
import { buildLtvBackfillRows, calculateLtvMetrics, estimateCustomerLtv } from '../../../scripts/backfill_ltv_metrics'
...
describe('[Capgo parity] estimated LTV metric backfill helpers', () => {
