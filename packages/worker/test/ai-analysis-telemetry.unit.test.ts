...
import { trackAiAnalysisChoice, trackAiAnalysisResult } from '../../cli/src/ai/telemetry'
...
describe('[Capgo parity] trackAiAnalysisChoice', () => {
  beforeEach(() => {
...
describe('[Capgo parity] trackAiAnalysisResult', () => {
  beforeEach(() => {
    sendEventMock.mockReset()
    sendEventMock.mockResolvedValue(undefined)
  })
  ...
  it('omits error_status when result is error but errorStatus is undefined', async () => {
    await trackAiAnalysisResult({
      apikey: 'cap_test_key',
      orgId: 'org-uuid-1',
      appId: 'com.example.app',
