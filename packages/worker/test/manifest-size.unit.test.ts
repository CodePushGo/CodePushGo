...
import { buildManifestDownloadSizeResult, normalizeManifestSizeFiles, parseManifestSizeVersionId } from '../src/manifest-size'

describe('[Capgo parity] manifest download size helpers', () => {
    ...
    const files = normalizeManifestSizeFiles([
      {
        ...
        file_hash: 'hash-a',
        download_url: 'https://plugin.codepushgo.test/files/read/attachments/path/index.html.br?key=42&device_id=device',
      },
      {
        file_name: 'index.html.br',
        file_hash: 'hash-a',
    ...
    const files = normalizeManifestSizeFiles([
      {
        file_name: 'index.html.br',
        file_hash: 'hash-a',
        download_url: 'https://plugin.codepushgo.test/files/read/attachments/path/index.html.br?key=42',
      },
      {
        file_name: 'main.js',
        file_hash: 'hash-b',
