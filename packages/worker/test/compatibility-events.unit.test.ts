import type { CompatibilityEventRow } from '../../../apps/dashboard/src/services/compatibilityEvents'
import { describe, expect, it } from 'vitest'
import { dependencyDiffPath, isResolved, platformLabel, reasonLabel } from '../../../apps/dashboard/src/services/compatibilityEvents'
...
function makeRow(overrides: Partial<CompatibilityEventRow> = {}): CompatibilityEventRow {
  return {
    ...
    offenders: ['@react-native-camera/camera'],
...
describe('[Capgo parity] platformLabel', () => {
...
describe('[Capgo parity] isResolved', () => {
...
describe('[Capgo parity] reasonLabel', () => {
...
describe('[Capgo parity] dependencyDiffPath', () => {
  it.concurrent('builds the diff link comparing current against previous', () => {
    ...
    expect(dependencyDiffPath('com.demo.app', row)).toBe('/app/com.demo.app/bundle/200/dependencies?compare=100')
  })
