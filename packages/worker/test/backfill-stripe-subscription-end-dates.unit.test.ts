import type { StripeSubscriptionSnapshot } from '../../../scripts/backfill_stripe_subscription_end_dates'
import { describe, expect, it } from 'vitest'
import { getStripeSubscriptionEndSnapshot } from '../../../scripts/backfill_stripe_subscription_end_dates'

function subscription(overrides: Partial<StripeSubscriptionSnapshot>): StripeSubscriptionSnapshot {
  return {
    cancel_at: null,
...
describe('[Capgo parity] stripe subscription end-date backfill helpers', () => {
