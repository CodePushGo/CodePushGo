import type { Compatibility } from '../../cli/src/bundle/compatibility'
import { describe, expect, it } from 'vitest'
import { summarizeUploadCompatibility } from '../../cli/src/bundle/compatibility'
...
describe('[Capgo parity] summarizeUploadCompatibility', () => {
  it.concurrent('reports skipped when the comparison did not run', () => {
  ...
  it.concurrent('reports compatible for an empty package set', () => {
