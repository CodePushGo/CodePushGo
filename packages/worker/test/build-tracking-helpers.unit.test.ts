...
import { classifyBuildTransition, mapBuildFailureCategory } from '../src/build-tracking'

describe('[Capgo parity] classifyBuildTransition', () => {
...
describe('[Capgo parity] mapBuildFailureCategory', () => {
