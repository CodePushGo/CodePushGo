...
import { mapBuilderUploadError, trackBuilderUpload } from '../../cli/src/build/telemetry'
...
describe('[Capgo parity] mapBuilderUploadError', () => {
...
describe('[Capgo parity] trackBuilderUpload', () => {
  beforeEach(() => {
