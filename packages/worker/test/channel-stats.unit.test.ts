...
import { channelStatsTestUtils } from '../src/channel-stats'

describe('[Capgo parity] channel stats helpers', () => {
  it('generateDateLabels builds an inclusive UTC range', () => {
  ...
  it('convertCountsToPercentagesByName keeps rounded totals at exactly 100', () => {
    ...
    const percentages = channelStatsTestUtils.convertCountsToPercentagesByName(counts, dates, versions)
