...
} from '../../../scripts/backfill_missing_store_urls'

describe('[Capgo parity] admin store URL backfill script helpers', () => {
  it('builds canonical Google Play and Apple lookup URLs', () => {
  ...
  it('filters missing platforms by selected store', () => {
    const app = {
  ...
  it('parses platform and Apple storefront options', () => {
  ...
  it('normalizes and selects Apple lookup App Store URLs by bundle id', () => {
