...
import { BUILDER_RECOVERY_MILESTONES, buildBuilderOnboardingBentoEvent } from '../src/builder-onboarding-recovery'

const base = { orgId: 'org-1', appId: 'com.demo.app', platform: 'ios', orgName: 'Demo Org', appName: 'Demo' }

describe('[Capgo parity] buildBuilderOnboardingBentoEvent', () => {
