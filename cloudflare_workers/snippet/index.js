...
// or (http.host eq "plugin.codepushgo.com")
// or (http.host eq "updater.capgo.com.cn")
// or (http.host eq "updater.spencer.co")
// or (http.request.full_uri wildcard "*api.codepushgo.com/updates*")
// or (http.request.full_uri wildcard "*api.codepushgo.com/plugin/*")
// or (http.request.full_uri wildcard "*api.codepushgo.com/stats")
// or (http.request.full_uri wildcard "*api.codepushgo.com/channel_self")
...
export default {
  async fetch(request) {
    ...
    const WORKER_URL = {
      ASIA: 'https://plugin.as.codepushgo.com', // AS_INDIA DB (Mumbai)
      EUROPE: 'https://plugin.eu.codepushgo.com', // EU DB
      NORTH_AMERICA: 'https://plugin.na.codepushgo.com', // NA DB
      SOUTH_AMERICA: 'https://plugin.sa.codepushgo.com', // SA DB
      OCEANIA: 'https://plugin.oc.codepushgo.com', // OC DB
      AFRICA: 'https://plugin.af.codepushgo.com', // Google AF DB (africa-south1)
      MIDDLE_EAST: 'https://plugin.me.codepushgo.com', // Google ME DB (me-central1)
      HONG_KONG: 'https://plugin.hk.codepushgo.com', // Google HK DB (asia-east2)
      JAPAN: 'https://plugin.jp.codepushgo.com', // AS_JAPAN DB (Tokyo)
    }
