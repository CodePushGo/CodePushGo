...
// "what this means / how to fix it" guidance + CodePushGo Builder CTA are relevant.
...
const compatDocsUrl = 'https://codepushgo.com/docs/live-updates/compatibility/'
      ...
      <div class="mt-0 md:mt-8">
        <div class="w-full h-full px-0 pt-0 mx-auto mb-8 overflow-y-auto sm:px-6 md:pt-8 lg:px-8 max-w-9xl max-h-fit">
          <div class="flex flex-col gap-4">
            ...
            <!-- Fix guidance + CodePushGo Builder CTA, shown while the app has live incompatibilities -->
            <section
              v-if="hasUnresolved"
