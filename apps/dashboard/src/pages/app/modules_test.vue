...
const pluginTests: PluginTest[] = [
  ...
  { packageName: '@capgo/capacitor-brightness', pluginName: 'CodePushGoBrightness', method: 'getPluginVersion', label: 'capacitor-brightness' },
  { packageName: '@capgo/capacitor-calendar', pluginName: 'CapacitorCalendar', method: 'checkAllPermissions', label: 'capacitor-calendar' },
  { packageName: '@capgo/capacitor-compass', pluginName: 'CodePushGoCompass', method: 'getPluginVersion', label: 'capacitor-compass' },
  { packageName: '@capgo/capacitor-crisp', pluginName: 'CapacitorCrisp', method: 'getPluginVersion', label: 'capacitor-crisp' },
  { packageName: '@capgo/capacitor-data-storage-sqlite', pluginName: 'CodePushGoCapacitorDataStorageSqlite', method: 'getPluginVersion', label: 'capacitor-data-storage-sqlite' },
  ...
  { packageName: '@capgo/capacitor-file-picker', pluginName: 'CodePushGoFilePicker', method: 'getPluginVersion', label: 'capacitor-file-picker' },
  ...
  { packageName: '@capgo/capacitor-in-app-review', pluginName: 'CodePushGoInAppReview', method: 'getPluginVersion', label: 'capacitor-in-app-review' },
  ...
  { packageName: '@capgo/capacitor-intercom', pluginName: 'CodePushGoIntercom', method: 'getUnreadConversationCount', label: 'capacitor-intercom' },
  ...
  { packageName: '@capgo/capacitor-light-sensor', pluginName: 'CodePushGoLightSensor', method: 'getPluginVersion', label: 'capacitor-light-sensor' },
  { packageName: '@capgo/capacitor-llm', pluginName: 'CodePushGoLLM', method: 'getPluginVersion', label: 'capacitor-llm' },
  ...
  { packageName: '@capgo/capacitor-persistent-account', pluginName: 'CapacitorPersistentAccount', method: 'getPluginVersion', label: 'capacitor-persistent-account' },
  {
    ...
    option: { id: 'sandbox-pretty-toast', title: 'CodePushGo plugin sandbox', message: 'PrettyToast bridge is available', duration: 2000 },
  },
  ...
  { packageName: '@capgo/capacitor-video-thumbnails', pluginName: 'CodePushGoVideoThumbnails', method: 'getPluginVersion', label: 'capacitor-video-thumbnails' },
