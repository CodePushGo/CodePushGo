...
function verifyWebhookSignature(rawBody, headers, secret) {
  const signature = headers['x-capgo-signature'] ?? headers['X-CodePushGo-Signature']
                ...
                <details class="mt-3">
                  ...
                  <div class="p-3 mt-2 bg-gray-100 border border-gray-200 rounded dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <ul class="mb-3 space-y-1 text-xs text-gray-600 list-disc list-inside dark:text-gray-400">
                      ...
                      <template v-else>
                        <li><code class="px-1 bg-gray-200 rounded dark:bg-gray-700">X-CodePushGo-Signature</code>: {{ t('legacy-header-signature-desc') }}</li>
                        <li><code class="px-1 bg-gray-200 rounded dark:bg-gray-700">X-CodePushGo-Timestamp</code>: {{ t('header-timestamp-desc') }}</li>
                        <li><code class="px-1 bg-gray-200 rounded dark:bg-gray-700">X-CodePushGo-Event-ID</code>: {{ t('header-event-id-desc') }}</li>
                      </template>
                    </ul>
