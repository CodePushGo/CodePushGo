...
describe('[Capgo parity] dashboard refresh helpers', () => {
  it.concurrent('detects stale and in-progress refresh states from timestamp strings without timezone suffixes', () => {
  ...
  it.concurrent('waits for the org cache timestamp to reach the refresh request timestamp', () => {
