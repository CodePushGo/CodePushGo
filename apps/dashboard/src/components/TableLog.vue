...
/* VueDatePicker theming using CSS variables - CodePushGo theme */
.dp__theme_light {
...
/* Global datepicker variables matching CodePushGo design */
:root {
...
/* Custom action buttons styling for CodePushGo */
