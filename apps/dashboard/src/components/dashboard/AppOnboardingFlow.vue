...
const cliCommand = computed(() => `npx @codepushgo/cli@latest i ${apiKey.value ?? '[APIKEY]'}${localCommand}`)
const redactedCliCommand = computed(() => `npx @codepushgo/cli@latest i [YOUR_CODEPUSHGO_API_KEY]${localCommand}`)
              ...
              <div class="rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-4 py-4 dark:border-white/20 dark:bg-slate-950/90">
                ...
                >
                  <code class="block whitespace-pre-wrap break-all text-sm">
                    ...
                    <span class="text-sky-300"> @codepushgo/cli@latest</span>
